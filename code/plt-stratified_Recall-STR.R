...
cols <- c("Filter", "METRIC.Recall", "TRUTH.TOTAL", "coverage", "Subset", "Subtype",
...
write.table(dt, "data/results/STR_recall.csv")
...
aes <- list(geom_point(alpha=0.6),
            ...
            theme_minimal(),
            labs(x = "Tandem Repeat Subclass", y = "Recall", color = "Variant Caller"),
